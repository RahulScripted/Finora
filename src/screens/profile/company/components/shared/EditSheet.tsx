...
export default function EditSheet({ label, value, visible, onSave, onClose }: Props) {
  ...
  return (
    <BottomSheet visible={visible} onClose={onClose} title={label}>
      <View style={s.inner}>
        ...
        />
        <PrimaryButton title={t("company.save")} onPress={() => onSave(draft)} />
      </View>
    </BottomSheet>
  );
}
